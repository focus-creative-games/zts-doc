...
| 术语 | 含义 | 实现落点 |
|------|------|----------|
| **ZenTS** | Product name (formerly ZTS). Unity C# ↔ JavaScript (QuickJS) interop; Editor Mono, Player Il2Cpp | `Packages/com.code-philosophy.zen-ts` |
| **zents** | Lowercase code id: JS stdlib `zents.*`, error prefix `zents:`, native dir `libil2cpp/zents` | [05-LIB.md](/docs/spec/05-LIB/) |
| **zen-ts** | Unity package / GitHub repo name; site [zen-ts.com](https://zen-ts.com) | [focus-creative-games/zen-ts](https://github.com/focus-creative-games/zen-ts) |
